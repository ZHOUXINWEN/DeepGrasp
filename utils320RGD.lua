...
function GetPriorBBoxes(cfg)
   ...
   a:copy(a_centers:view(cfg.bpc[1], 1, 1):expand(cfg.bpc[1], cfg.msize[1], cfg.msize[1]))
    --print(output_view)
   local tmp_prior_box = output_view:view(-1,10,10):transpose(1,2):transpose(2,3)
